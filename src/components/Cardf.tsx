import LinksCardF from '@/components/LinksCardF'

export default function Cardf() {
  return (
    <div className="flex h-28 w-72 items-center rounded-md bg-black p-3 shadow-lg">
      ...
      <section className="m-3 block border-l border-gray-300">
        <div className="pl-3">
          ...
          <h3 className="text-md bg-gradient-to-l from-[#cecece] to-[#00aeff] bg-clip-text font-bold text-transparent">
